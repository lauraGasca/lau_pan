@section('contenido')
    <div class="mail-apps-wrap">
        <div class="the-box bg-success no-border no-margin heading">
            <div class="row">
                <div class="col-sm-6">
                    <h1><i class="fa fa-plus icon-lg icon-circle icon-bordered"></i> Agregar Suscriptor</h1>
                </div>
            </div>
        </div><br/>
        <div class="the-box no-margin">
            ...
            @endif
            {{ Form::open(array('url'=>'suscripciones/crear', 'method' => 'post', 'enctype'=>'multipart/form-data') )}}
                <div class="row">
                    <div class="col-sm-12">
