@section('contenido')
    <div class="mail-apps-wrap">
        <div class="the-box bg-success no-border no-margin heading">
            <div class="row">
                <div class="col-sm-6">
                    <h1><i class="fa fa-plus icon-lg icon-circle icon-bordered"></i> Agregar Producto</h1>
                </div>
            </div>
        </div><br/>
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    @endif
                    <div class="the-box">
                        {{ Form::open(array('url'=>'producto/crear', 'method' => 'post', 'enctype'=>'multipart/form-data') )}}
